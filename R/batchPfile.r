...
#'
#' @param demNameL List containing the names of the demographic variables for pfiles.
...
batch.pfile<-function(demNameL, dir = getwd(), pattern = "Pfile", r2WinstepsFile = TRUE){ #THINK ABOUT DROPPING DATA FRAME REQUIREMENT

...
#'   that the \code{length(iFileNames)} must equal \code{length(varWidths)}.
...
#' @export
#' @return List of Winsteps ifiles, where each element of the list represents
#'  a different ifile.

batch.ifile <- function(dir = getwd(), pat = "Ifile", files = NULL, 
